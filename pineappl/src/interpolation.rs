...
mod tests {
    ...
    fn interpolate_two_points() {
        ...
        let x_reference = [
            1.0,
            9.309440808716655e-1,
            8.627839323906108e-1,
            7.956242522922757e-1,
            7.295868442414312e-1,
            6.648139482473711e-1,
            6.01472197967335e-1,
            5.397572337880446e-1,
            4.7989890296102555e-1,
            4.2216677535896485e-1,
            3.668753186482242e-1,
            3.143874007692335e-1,
            2.65113704158282e-1,
            2.1950412650038867e-1,
            1.780256604256944e-1,
            1.4112080644438132e-1,
            1.0914375746330697e-1,
            8.228122126204893e-2,
            6.048002875444742e-2,
            4.341491741701319e-2,
            3.052158400782889e-2,
            2.108918668378718e-2,
            1.4375068581090129e-2,
            9.699159574043398e-3,
            6.496206194633799e-3,
            4.328500638819831e-3,
            2.8738675812817133e-3,
            1.9034634022867352e-3,
            ...
            6.843744918967896e-5,
            4.511438394964044e-5,
            2.97384953722449e-5,
            1.960250500238325e-5,
            1.2921015690745727e-5,
            8.516806677573052e-6,
            5.613757716930101e-6,
            3.700227206985489e-6,
            2.4389432928916775e-6,
            1.607585498470808e-6,
            1.0596094959101024e-6,
            6.984208530700364e-7,
            4.6035014748963986e-7,
            3.034304765867952e-7,
            1.9999999999999989e-7,
        ];
        ...
        for (&node, ref_node) in node_values[1].iter().zip(x_reference) {
            assert_approx_eq!(f64, node, ref_node, epsilon = 1e-15);
        }
    ...
    #[test]
    fn applgrid_fx2_fy2_closure() {
        let x_ref = Interp::new(
            2e-7,
            1.0,
            50,
            3,
    ...
    #[test]
    fn applgrid_ftau0_fq20_closure() {
        let q2_ref = Interp::new(
            1e2,
            1e8,
            40,
            3,
